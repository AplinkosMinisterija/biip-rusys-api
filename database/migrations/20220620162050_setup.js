...
exports.up = function (knex) {
  return knex.schema
    .createTableIfNotExists('users', (table) => {
      ...
      table
        .enu('type', ['USER', 'ADMIN'], { useNative: true, enumName: 'user_type' })
        .defaultTo('USER');
      commonFields(table);
    })
    ...
    .createTableIfNotExists('forms', (table) => {
      ...
      table
        .enu('densityType', ['IN_HECTARE', 'IN_METER'], {
          useNative: true,
      ...
      table.text('geo');
      table
        .enu('status', ['RELEVANT', 'IRRELEVANT', 'REJECTED'], {
          useNative: true,
          enumName: 'form_status',
        })
        .defaultTo('RELEVANT');
      table
        .enu('state', ['SUBMITTED', 'REJECTED', 'RETURNED', 'APPROVED'], {
          useNative: true,
          enumName: 'form_state',
        })
        .defaultTo('SUBMITTED');
    ...
    .createTableIfNotExists('places', (table) => {
      ...
      table
        .enu(
          'status',
          ['INITIAL', 'STABLE', 'INCREASED', 'DECREASED', 'DISAPPEARED', 'DESTROYED'],
          { useNative: true, enumName: 'place_status' },
        )
        .defaultTo('INITIAL');
      table.integer('speciesId').unsigned().notNullable();
      table.text('geo');
